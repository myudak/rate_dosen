...
export function FeatureCarouselDemo() {
  return (
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6">
      <div className="rounded-[24px] bg-neutral-700 p-1.5 sm:rounded-[34px] sm:p-2">
        <div className="relative z-10 grid w-full gap-4 rounded-[20px] bg-neutral-950 p-1.5 sm:gap-8 sm:rounded-[28px] sm:p-2">
          <FeatureCarousel
